#include "DualL298NMotorShield4WD.h"

// Constructors ////////////////////////////////////////////////////////////////

DualL298NMotorShield4WD::DualL298NMotorShield4WD()
{
  //Pin map
...
// Public Methods //////////////////////////////////////////////////////////////
void DualL298NMotorShield4WD::init()
{
...
void DualL298NMotorShield4WD::setM1Speed(int speed)
{
...
void DualL298NMotorShield4WD::setM2Speed(int speed)
{
  unsigned char reverse = 0;
...
void DualL298NMotorShield4WD::setM3Speed(int speed)
{
  unsigned char reverse = 0;
...
void DualL298NMotorShield4WD::setM4Speed(int speed)
{
  unsigned char reverse = 0;
...
void DualL298NMotorShield4WD::setSpeeds(int m1Speed, int m2Speed, int m3Speed, int m4Speed)
{
  setM1Speed(m1Speed);
  setM2Speed(m2Speed);
  setM3Speed(m3Speed);
